...
public class RootLayoutController {
    ...
    /**
     * Opens a FileChooser to let the user select a Website to load.
     */
    @FXML
    ...
    /**
     * Saves the file to the Website file that is currently open. If there is no
    ...
    private void handleAbout() {
    	...
    	alert.setContentText("Author: Semida");
